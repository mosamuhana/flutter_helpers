...
import 'property_change_provider.dart';
...
///
/// ```
class PropertyChangeConsumer<T extends PropertyChangeNotifier<S>, S extends Object>
...
// ignore nonfunction-type-aliases
typedef StringPropertyChangeConsumer<T extends PropertyChangeNotifier<String>>
    = PropertyChangeConsumer<T, String>;
