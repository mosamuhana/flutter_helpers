...
import 'property_change_notifier.dart';
...
/// ```
class PropertyChangeProvider<T extends PropertyChangeNotifier<S>, S extends Object>
...
class _PropertyChangeProviderState<T extends PropertyChangeNotifier<S>, S extends Object>
    extends State<PropertyChangeProvider<T, S>> {
  Set<S> _properties = {};
...
/// The type parameter [T] is the type of the [PropertyChangeNotifier<S>] subclass.
/// The type parameter [S] is the type of the properties to observe.
class PropertyChangeModel<T extends PropertyChangeNotifier<S>, S extends Object>
    extends InheritedModel<S> {
  ...
  @override
  bool updateShouldNotify(PropertyChangeModel oldWidget) => true;
...
typedef StringPropertyChangeProvider<T extends PropertyChangeNotifier<String>>
    = PropertyChangeProvider<T, String>;
